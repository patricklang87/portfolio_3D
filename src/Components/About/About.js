        ...
        <div id="about">
            ...
            <div className='about'> 
                ...
                <div className='aboutInfo'>
                    <h2>About Me</h2>
                    <p>I am a self-taught web developer working to break into the industry. I'm constantly working to expand my skillset. I enjoy both frontend and backend challenges, and, as a former language instructor, am interested in learning more about NLP and manipulating language digitally!</p>
